...
```
1. https://autodealership.preview.emergentagent.com/
   → Should show navbar at top + Home page

2. https://autodealership.preview.emergentagent.com/used
   → Should show navbar + Used page

3. https://autodealership.preview.emergentagent.com/vehicles
   → Should show navbar + 112 vehicles

4. https://autodealership.preview.emergentagent.com/vehicle/P57801
...
**4. Test Static Files:**
```
https://autodealership.preview.emergentagent.com/static/js/main.*.js
