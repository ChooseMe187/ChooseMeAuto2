...
- URL: https://autoleads-1.preview.emergentagent.com/
...
**API Calls:**
- `${API_BASE}/api/vehicles` → `https://autoleads-1.preview.emergentagent.com/api/vehicles`
- `${API_BASE}/api/vehicles/{stock_id}` → `https://autoleads-1.preview.emergentagent.com/api/vehicles/{stock_id}`
- `${API_BASE}/api/vehicle-leads` → `https://autoleads-1.preview.emergentagent.com/api/vehicle-leads`
...
# Get lead count
curl https://autoleads-1.preview.emergentagent.com/api/vehicle-leads/count
```
...
# Test a few more
curl -I https://autoleads-1.preview.emergentagent.com/vehicles/P58496_1.jpg
```
...
- Open https://autoleads-1.preview.emergentagent.com/vehicles
- Open Network tab
...
# Should output: https://autoleads-1.preview.emergentagent.com
```
